...
window.onload = (event) => {
    ...
    switch (mapName) {
        ...
        case "world":
            ...
            L.marker([-0.484, 2.297], {icon: questIcon}).on('click', markerClicked).addTo(questGroup).bindPopup("mash");
            ...
            L.marker([-0.539, 3.531], {icon: questIcon}).on('click', markerClicked).addTo(questGroup).bindPopup("heart_of_gold");
